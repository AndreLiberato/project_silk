  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ListTile(
              ...
              title:  Text("#${widget.order.number.toString()}", textAlign: TextAlign.center, style: const TextStyle(color: Colors.black, fontSize: 20, fontFamily: "Acme")),
              ...
              trailing: Text("R\$ ${widget.order.valor.toStringAsFixed(2)}", style: const TextStyle(color: Color(0xFFf65c05), fontSize: 20, fontFamily: "Acme"), textAlign: TextAlign.center,),
            ),
    );
  }
